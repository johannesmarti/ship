...
from consumption import SavingConsumer
...
consumer = SavingConsumer(utility_coefficients, 0.03)
...
def print_consumers(group):
    ...
    w = wages(group)
    print("wages:", w)
    utility_per_pop = consumer.utility(consumptions[group], savings[group])
