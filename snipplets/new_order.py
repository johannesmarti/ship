...
utility_coefficients = np.array([2,1,0.7,0.1,1])
...
def one_iteration(prices):
    ...
    print("supply", supply[10:14])
    supply = np.maximum(0.0000000001,supply)
    for i in range(num_groups):
...
while True:
    ...
    print("new prices", new_prices[10:14])
    ...
    if badness < 0.001:
        ...
        prices = 0.4*prices + 0.6*new_prices
