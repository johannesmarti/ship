...
const arrangement = new Arrangement([], [0,1,2], [3,4])
...
console.assert(arrangement.isMovable(Position.column(1), Position.fixed(0)),
  "movable from columne hierarchy to fixed");
console.assert(arrangement.isMovable(Position.column(0), Position.column(2)),
  "movable inside of columne hierarchy to fixed");
...
arrangement.move(Position.column(1), Position.fixed(0), 2);
// arrangement = new Arrangement([(4,2)], [0,1,2], [3])

arrangement.move(Position.column(0), Position.row(1), 1);
...
arrangement.move(Position.fixed(0), Position.row(0), 2);
